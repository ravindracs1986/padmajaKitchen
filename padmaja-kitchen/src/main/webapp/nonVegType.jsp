...
<c:set var="nonVegVideoList" value="${requestScope.nonVegVideoList}" />
			...
			<div class="row">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li  class="active"><a href="${pageContext.request.contextPath}/NonVegRecipeType">NONVEG RECIPES</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="latest-product">
						<h2 class="section-title">Non-Veg Recipe</h2>
						<div class="product-carousel">
							<c:forEach var="product" items="${nonVegVideoList}" varStatus="i">
								<%-- ${product}<br> --%>
								<div class="single-product">
									...
									<h2>
										<a href="single-product.jsp">${product.video_name}</a>
									</h2>
								</div>
							</c:forEach>
