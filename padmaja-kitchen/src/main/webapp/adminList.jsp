					...
					<div class="product-content-right">
						<div class="woocommerce" align="center">
							...
							<form id="login-form-wrap"
								action="${pageContext.request.contextPath}/SaveVideoController.do"
								method="post">
								...
								<p id="billing_country_field"
									...
									<label class="" for="category">Category<abbr
										title="required" class="required">*</abbr>
									</label> <select class="country_to_state country_select" id="category"
										name="category">
								...
								<p class="form-row form-row-last">
									...
									</label> <input type="text" id="videoUrl" name="videoUrl"
										class="input-text">
								</p>
								<p class="form-row form-row-last">
									<label for="youTubeId">YouTubeId <span class="required">*</span>
									</label> <input type="text" id="youTubeId" name="youTubeId"
										class="input-text">
								</p>
								<div class="clear"></div>
