...
<%@page
	import="javax.servlet.*,javax.servlet.http.*,java.sql.*,java.io.*,org.apache.commons.codec.binary.Base64"%>
                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                  <iframe width="560" height="315" src="https://www.youtube.com/embed/Db3tAbE5IBc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								   
									<div class="product-hover">
                                       <!-- <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>-->
                                        <a href="https://youtu.be/Db3tAbE5IBc" class="view-details-link" target="_blank"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                </div>
                                
                                <h2><a href="single-product.jsp">Poha</a></h2>
                                
                                 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/BroWI01Q6Zw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    <div class="product-hover">
                                        <a href="https://youtu.be/BroWI01Q6Zw" class="view-details-link" target="_blank"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                </div>
