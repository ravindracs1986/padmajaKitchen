...
<body>
<c:set var="vegVideoList" value="${requestScope.vegVideoList}" />
			...
			<div class="row">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="${pageContext.request.contextPath}/VegRecipeType">VEG RECIPES</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="latest-product">
						<h2 class="section-title">Veg Recipe</h2>
						<div class="product-carousel">
							<c:forEach var="product" items="${vegVideoList}" varStatus="i">
								<%-- ${product}<br> --%>
