			...
			<div class="row">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li><a
							href="${pageContext.request.contextPath}/VegRecipeType">VEG
								RECIPES</a></li>
						<li><a
							href="${pageContext.request.contextPath}/NonVegRecipeType">NONVEG
								RECIPES</a></li>
	...
	<div id="content">
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					<div class="blog-post">
						...
						<div class="post-content">
							<h3 class="post-title">
								<a href="#"><u>maggi pakoda recipe with all Details:</u></a>
							</h3>
							<div class="meta">
							...
							<p><b>maggi pakoda recipe | maggi ke pakode | maggi pakora
								recipe </b>with detailed photo and video recipe. perhaps one of the
								recent innovation in the domain of street food recipes using
								maggi noodles. the recipe is often misjudged to onion pakora due
								to its appearance and crisp but has its own unique taste and
								flavour. it is perhaps one of the easy pakoda recipes and it
								hardly takes minutes to prepare including making 2-minute maggi
								noodles.</p>
							<img src="assets/img/thumbnailarbi.png" alt="">
							<p>maggi pakoda recipe | maggi ke pakode | maggi pakora
								recipe with step by step photo and video recipe. since the
								inception of 2 minutes maggi noodles, it has not only been
								appreciated for its taste. but also has given to myriad of
								fusion and creative recipes using cooked maggi noodles. one such
								cosmopolitan or urban dwellers favourite recipe is maggi pakora
								or maggi pakoda made with cooked noodles and deep fried.</p>
							<p>as i previously mentioned, the appearance of maggi pakoda
								is very similar to the onion pakora recipe. basically, the
								noodles when deep fried with besan and corn flour coating
								results same as onion crisp. having said that in addition to
								maggi noodles i have also added finely sliced vegetables like
								carrots, capsicum and onions. this as a package makes it a
								complete noodle based vegetable pakoda. but the maggi bhajiya
								can be just prepared with noodles without any vegetable
								adulteration. i personally like it this way as just noodles can
								be overwhelming taste and to neutralise the strong maggi
								tastemaker flavour, it is recommended to add vegetables of your
								choice.</p>

							<img src="assets/img/arbi2.png" alt="">
								<p>finally, i request you to check my other street food
									recipes collection with this post maggi pakora recipe. this
									mainly includes recipes like maggi momos, maggi soup, street
									style maggi noodles, corn pakora, sooji ka pakora, palak pakoda
									and cabbage pakora. in addition i request you to check my other
									related recipes collection like,</p>
								<h3><b>maggi pakoda video recipe:</b></h3> <iframe width="800"
									height="315" src="https://www.youtube.com/embed/LzmmtEiFl7Q"
									frameborder="0"
									allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
									allowfullscreen></iframe>

								<br/><h3><b>recipe card for maggi ke pakode:</b></h3>
							...
							<div class="widget widget-categories">
								...
								<ul class="cat-list">
									...
									<li>additionally, adding corn flour and rice flour makes
										pakoda crispier.<span class="num-posts"></span>
									</li>
									<li>also, fry on low to medium flame to make pakode more
										crispy. <span class="num-posts"></span>
									</li>
									<li>finally, maggi pakoda recipe tastes great when served
										hot and crispy. <span class="num-posts"></span>
									</li>
				...
				<br />
				<aside id="sidebar" class="col-md-3 right-sidebar"> <!-- <div class="widget widget-search">
				...
				<!-- <div class="widget tag">
					...
					<a href="#"> Jobpress</a> <a href="#"> Recruiter</a> <a href="#">
						...
						href="#"> HR</a> <a href="#"> Salary</a> <a href="#"> Employer</a>
				</div>
					...
					<div class="single-product-widget">
						...
						<div class="single-wid-product">
							...
							<div class="product-wid-price">
								<a href="https://youtu.be/${product.youtube_id}"
